...
rule subsample:
    input:
        ...
        config="results/{a_or_b}/{build_name}/{resolution}/subsample_config.yaml",
        referenced_files=lambda w: get_referenced_files(f"results/{w.a_or_b}/{w.build_name}/{w.resolution}/subsample_config.yaml"),
    output:
